...
### 2026-09-24 (2회차) — 데이터랩 재연결 후 통계·순위 점검 (10주차 주제 확정용)

- **관측(통계, 기간 명시)**: 방문수 최근 14일(9/11~9/24) 174 vs 직전 14일 467(-62.7%, 진행 중인 기간이라 낮게 보일 수 있음). 평시 하루 6~11회인데 **9/23 24회·9/24 43회로 이틀 연속 상승**(9/15 20회 이후 처음, 원인 미확인 — 9주차 글·교육뉴스 발행일 직후 패턴과 겹침). 유입 검색어 표본이 3건뿐이라(각 4.3%) 검색어 분석은 의미 없음.
- **관측(순위, 9/19 대비)**:

| 키워드 | 블로그탭 | 통합검색 | 플레이스 |
|---|---|---|---|
| 우만동 수학학원 | 1위(유지) | 5위(3→5 하락) | 4위(155개 중, 유지 추정 — 결과 목록 4번째) |
| 동수원중 수학학원 | 2위(1→2) | 4위(3→4) | 순위권 밖(485개, 상위 10곳 광교·매탄) |
| 동성중수학학원 | 1위(유지) | 9위(3→9 하락) | 5위(유지) |
| 창현고수학학원 | 4위(3→4) | 노출 안 됨(5→미노출) | 순위권 밖(309개, 상위 10곳 광교) |
| 유신고수학학원 | 2위(유지) | 14위(3→14 하락) | 순위권 밖(323개, 상위 10곳 광교) |
| 산남중수학학원 | 19위(14→19) | 노출 안 됨(유지) | 순위권 밖(532개, 매탄·인계권) |
| 광교고수학학원 | 11위(4→11) | 9위(10→9) | 해당 없음 |
