...
- `--phase blog` (화요일 10:00 KST): 구글 블로그만 발행하고 끝낸다. 다른 채널
  ...
  기다린다.
- `--phase cardnews` (수요일 10:00 KST, 2026-09-13부로 20:00→10:00): 블로그가 이미
  끝나 있다고 가정하고 (안 끝나 있으면 에러) 카드뉴스 캐러셀 2채널(FB 캐러셀·IG
  캐러셀)을 동시에 발행한다.
- `--phase social` (목요일 10:00 KST, 2026-09-13부로 20:00→10:00): 블로그가 이미 끝나 있다고 가정하고
